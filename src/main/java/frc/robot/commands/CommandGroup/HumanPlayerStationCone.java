...
public class HumanPlayerStationCone extends SequentialCommandGroup {
  /** Creates a new HumanPlayerStationCone. */
  public HumanPlayerStationCone(PivotArmSubsystem pivotArmSubsystem,
  ...
  IntakeSubsystem intakeSubsystem) {
    ...
    ,new ParallelDeadlineGroup(new ExtensionAtTargetPosition(extensionArmSubsystem, -13, false), new ToggleExtensionTargetPosition(extensionArmSubsystem, -13))
