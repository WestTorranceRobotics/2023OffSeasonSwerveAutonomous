...
public class ScoreMiddleCone extends SequentialCommandGroup {
  /** Creates a new ScoreMiddleCone. */
  public ScoreMiddleCone(PivotArmSubsystem pivotArmSubsystem,
  ...
  IntakeSubsystem intakeSubsystem) {
    ...
    , new ParallelDeadlineGroup(new WristAtTarget(wristSubsystem, -30, false),new ToggleWristTargetPosition(wristSubsystem, -30))
    );
  }
}
